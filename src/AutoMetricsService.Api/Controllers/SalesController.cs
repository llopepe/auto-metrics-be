...
namespace AutoMetricsService.Api.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        {
            // llama al comando
            return await sender.Send(new GetTotalSalesVolumeQuery(), cancellationToken);
        }
       ...
       Description = "Obtiene los datos paginados")]
        public async Task<PaginatedList<PercentageGlobalDto>> GetPercentageGlobalWithPagination(ISender sender, [FromQuery] GetPercentageGlobalWithPaginationQuery query,
                                                                            CancellationToken cancellationToken)
        {
            // llama al comando
            return await sender.Send(query, cancellationToken);
