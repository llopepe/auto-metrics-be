...
{
    public class GetSalesByCenterWithPaginationQueryValidation : AbstractValidator<GetSalesByCenterWithPaginationQuery>
    {
        private readonly ICenterRepository _centerRepository;

        // Validaciones de datos de entreda de la query
        public GetSalesByCenterWithPaginationQueryValidation(ICenterRepository centerRepository)
        {
